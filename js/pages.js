...
function renderDashboard() {
  ...
  // Charts
  if (!chartsInitialized['evolution']) {
    ...
    chartsInitialized['evolution'] = true;
  }

  if (!chartsInitialized['donut-'+yr]) {
    ...
    if (canvas) {
      ...
      chartsInitialized['donut-'+yr] = true;
    }
  }
}
...
function renderCartographie() {
  ...
  if (!chartsInitialized['chart-provinces']) {
    const canvas = document.getElementById('chart-provinces');
    if (canvas) {
      new Chart(canvas, {
        type: 'bar',
        data: {
      ...
      chartsInitialized['chart-provinces'] = true;
    }
  }
}
...
function renderSrmnea() {
  ...
  if (!chartsInitialized['srmnea-cat']) {
    ...
    chartsInitialized['srmnea-cat'] = true;
  }
}
...
function renderSha2011() {
  ...
  if (!chartsInitialized['sha']) {
    const canvas = document.getElementById('chart-sha');
    if (canvas) {
      new Chart(canvas, {
        type:'doughnut',
        data:{
